...
return [
    ...
    */
    ...
    'searchableAttributes' => ['title', 'slug', 'author', 'content', 'excerpt', 'status'],
    ...
    */
    ...
    'customRanking' => ['desc(rating)', 'desc(publish_date)', 'desc(updated_at)', 'desc(deleted_at)'],
    ...
    */
    ...
    'attributesForFaceting' => ['article_type_id', 'article_type'],
