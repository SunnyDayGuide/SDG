<div class="card-columns">
  <div class="card text-white overlay text-right">
    ...
    <div class="card-img-overlay d-flex flex-column justify-content-end">
      ...
      <p class="card-text">A perfect family vacation spot known for its legendary live shows.</p>
    </div>
  </div>
  ...
  <div class="card text-primary overlay text-left">
    ...
    <div class="card-img-overlay">
      ...
      <p class="card-text">200 miles of beautiful scenery, adventure, and fun vacation memories</p>
    </div>
  </div>
  ...
  <div class="card text-white overlay text-left">
    ...
    <div class="card-img-overlay">
      ...
      <p class="card-text">The swaying palms and relaxed beach atmosphere are the perfect escape.</p>
    </div>
  </div>
  ...
  <div class="card text-primary overlay text-left">
    ...
    <div class="card-img-overlay d-flex flex-column justify-content-end">
      ...
      <p class="card-text">Find your ideal getaway on one of these treasures of the Atlantic coast</p>
    </div>
  </div>
  ...
  <div class="card text-white overlay text-right">
    ...
    <div class="card-img-overlay d-flex flex-column justify-content-end">
      ...
      <p class="card-text">Renowned for its engaging activities, beautiful scenery, wide-open natural environments and vibrant urban areas</p>
    </div>
  </div>
  ...
  <div class="card p-3 text-right">
    <blockquote class="blockquote mb-4">
      <p>A vacation is having nothing to do and all day to do it in.</p>
  ...
  <div class="card text-white overlay text-right">
    ...
    <div class="card-img-overlay">
      ...
      <p class="card-text">Thrilling amusements, exhilarating activities, and incredible festivals</p>
    </div>
  </div>
  ...
  <div class="card text-white overlay text-left">
    ...
    <div class="card-img-overlay d-flex flex-column justify-content-end w-75">
      ...
      <p class="card-text">Jamestown, Williamsburg, and Yorktown – Where the Past <br>Meets the Future</p>
    </div>
  </div>
  ...
  <div class="card text-white overlay text-right">
    ...
    <div class="card-img-overlay">
      ...
      <p class="card-text">Rustic beauty, vast wilderness, and the small-town charm of yesteryear</p>
    </div>
  </div>
  ...
  <div class="card text-primary overlay text-left">
    ...
    <div class="card-img-overlay">
      ...
      <p class="card-text">A beachside resort playground – nostalgic, entertaining and unique</p>
    </div>
  </div>
  ...
  <div class="card text-primary overlay text-left">
    ...
    <div class="card-img-overlay">
      ...
      <p class="card-text">A beach vacation that has it all—fun, excitement, relaxation, and entertainment</p>
    </div>
  </div>
