   ...
   <div class="card text-white overlay text-left">
    ...
    <div class="card-img-overlay">
      <a href="{{ route('market.home', 'outer-banks') }}" class="stretched-link text-reset text-decoration-none">
        <h3 class="card-title">Outer Banks, Blah Blah Blah</h3>
      </a>
      <p class="card-text">This is one short blurb about Branson. Could be more? Let's intro the area!</p>
    </div>
  </div>
   ...
   <div class="card text-white overlay text-left">
    ...
    <div class="card-img-overlay">
      ...
      <a href="{{ route('market.home', 'sarasota-bradenton') }}" class="stretched-link text-reset text-decoration-none">
        <h3 class="card-title">Florida's Suncoast</h3>
      </a>
    </div>
  </div>
   <div class="card text-white overlay text-left">
    ...
    <div class="card-img-overlay">
      <a href="{{ route('market.home', 'hatteras-ocracoke') }}" class="stretched-link text-reset text-decoration-none">
        <h3 class="card-title">Hatteras-Ocracoke</h3>
      </a>
      <p class="card-text">You're on Island Time Now!</p>
    </div>
  </div>
   ...
   <div class="card text-white overlay text-left">
    ...
    <div class="card-img-overlay">
      <a href="{{ route('market.home', 'virginia-beach') }}" class="stretched-link text-reset text-decoration-none">
        <h3 class="card-title">Virginia Beach</h3>
      </a>
   ...
   <div class="card text-white overlay text-left">
    ...
    <div class="card-img-overlay">
      <a href="{{ route('market.home', 'delaware-beaches') }}" class="stretched-link text-reset text-decoration-none">
        <h3 class="card-title">Delaware Coast</h3>
      </a>
   ...
   <div class="card text-white overlay text-left">
    ...
    <div class="card-img-overlay">
      <a href="{{ route('market.home', 'smoky-mountains') }}" class="stretched-link text-reset text-decoration-none">
        <h3 class="card-title">Smoky Mountains, Blah Blah etc</h3>
      </a>
      <p class="card-text">This is one short blurb about the Smokies. Could be more? Let's intro the area!</p>
    </div>
  </div>
  <div class="card text-white overlay text-left">
    ...
    <div class="card-img-overlay">
      ...
      <p class="card-text">This is one short blurb about OCMD. Could be more? Let's intro the area!</p>
    </div>
  </div>
  <div class="card text-white overlay text-left">
    ...
    <div class="card-img-overlay">
      ...
      <p class="card-text">This is one short blurb about Myrtle Beach. Could be more? Let's intro the area!</p>
    </div>
  </div>
  <div class="card text-white text-center p-3">
    <blockquote class="blockquote mb-0">
