...
<div class="card-columns category-gallery">
	<div class="card text-white overlay text-right">
		<img src="{{ asset('images/myrtle-beach/home/activities-inset.jpg') }}" class="card-img" alt="...">
	...
	<div class="card text-white overlay text-left">
		<img src="{{ asset('images/myrtle-beach/home/dining-inset.jpg') }}" class="card-img" alt="...">
	...
	<div class="card text-white overlay text-left">
		<img src="{{ asset('images/myrtle-beach/home/shopping-inset.jpg') }}" class="card-img" alt="...">
		<div class="card-img-overlay d-flex flex-column justify-content-end">
	...
	<div class="card text-white overlay text-right">
		<img src="{{ asset('images/myrtle-beach/home/events-inset.jpg') }}" class="card-img" alt="...">
		<div class="card-img-overlay d-flex flex-column justify-content-end">
	...
	<div class="card text-white overlay text-right">
		<img src="{{ asset('images/myrtle-beach/home/accommodations-inset.jpg') }}" class="card-img" alt="...">
		<div class="card-img-overlay">
