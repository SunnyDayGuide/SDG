...
<div class="card-columns category-gallery">
	<div class="card text-white overlay text-right">
		<img src="{{ asset('storage/images/branson/home/entertainment-inset.jpg') }}" class="card-img" alt="...">
	...
	<div class="card text-white overlay text-right">
		<img src="{{ asset('storage/images/branson/home/activities-inset.jpg') }}" class="card-img" alt="...">
	...
	<div class="card text-white overlay text-left">
		<img src="{{ asset('storage/images/branson/home/dining-inset.jpg') }}" class="card-img" alt="...">
	...
	<div class="card text-white overlay text-right">
		<img src="{{ asset('storage/images/branson/home/shopping-inset.jpg') }}" class="card-img" alt="...">
		<div class="card-img-overlay d-flex flex-column justify-content-end">
	...
	<div class="card text-white overlay text-left">
		<img src="{{ asset('storage/images/branson/home/events-inset.jpg') }}" class="card-img" alt="...">
		<div class="card-img-overlay d-flex flex-column justify-content-end">
