...
<div class="card-columns category-gallery">
	<div class="card text-white overlay text-left">
		<img src="{{ asset('storage/images/sanibel-captiva/home/activities-inset.jpg') }}" class="card-img" alt="...">
	...
	<div class="card text-white overlay text-right">
		<img src="{{ asset('storage/images/sanibel-captiva/home/dining-inset.jpg') }}" class="card-img" alt="...">
	...
	<div class="card text-white overlay text-left">
		<img src="{{ asset('storage/images/sanibel-captiva/home/shopping-inset.jpg') }}" class="card-img" alt="...">
		<div class="card-img-overlay d-flex flex-column justify-content-end">
	...
	<div class="card text-white overlay text-right">
		<img src="{{ asset('storage/images/sanibel-captiva/home/events-inset.jpg') }}" class="card-img" alt="...">
		<div class="card-img-overlay d-flex flex-column justify-content-end">
			<a href="{{ route('events', $market) }}" class="stretched-link text-reset text-decoration-none">
				<h3 class="card-title">Events</h3>
			</a>
			<p class="card-text">What's happening on the Islands?</p>
		</div>
	</div>
	<div class="card text-white overlay text-left">
		<img src="{{ asset('storage/images/sanibel-captiva/home/accommodations-inset.jpg') }}" class="card-img" alt="...">
		<div class="card-img-overlay">
			...
			<p class="card-text">Find your perfect hotel,<br>resort or rental</p>
		</div>
	</div>	
</div>