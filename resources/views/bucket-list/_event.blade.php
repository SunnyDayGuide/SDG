<div class="card card-article">
	<div class="card-body p-0">
		<h5 class="text-editorial card-title mb-0">{{ $event->title }}</h5>
		...
		<div class="events-links my-3"><a href="{{ $event->website_url }}" target="_blank" class="btn btn-editorial">More Info</a></div>
	</div>
</div>